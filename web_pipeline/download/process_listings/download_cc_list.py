...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Download Common Crawl index dumps.")
    parser.add_argument('--save_path', type=str, default="./commoncrawlList/",
                        help="Path to save the downloaded Common Crawl list.")
    parser.add_argument('--skip_existing_dumps', type=bool, default=True,
...
def main():
    ...
    existing_dumps = set(os.listdir(args.save_path)) if args.skip_existing_dumps else set()
